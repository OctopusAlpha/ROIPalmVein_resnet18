...
def SigleCompare():
    ...
    # 设置测试图像路径
    image_path1 = 'dataset/valid/001/00004.bmp'
    # image_path2 = 'dataset/valid/002/00020.bmp'
    # image_path2 = 'dataset/valid/001/00004.bmp'
    image_path2 = 'dataset\\valid\\004\\00031.bmp'
    # 预处理图像（包括ROI提取和增强）
    print('处理第一张图像...')
...
def BatchCompare(num_pairs=100, threshold=0.8, visualize=False):
    ...
    while diff_person_pairs < target_pairs_each and len(person_ids) >= 2:
        ...
        # 获取两个人的图像
        images1 = [f for f in os.listdir(person_dir1) if f.endswith('.bmp')]
        images2 = [f for f in os.listdir(person_dir2) if f.endswith('.bmp')]
